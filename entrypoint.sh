...
RESULTS_FILE="/tmp/results.json" # File written by act step
...
ID_INDEX_MAP_FILE="/tmp/id_index_map.json" # File to store ID -> Index mapping
PRESETS_DIR="/presets"
...
# Start workflow structure and ID->Index map
echo "{}" > "$ID_INDEX_MAP_FILE" # Initialize map file
